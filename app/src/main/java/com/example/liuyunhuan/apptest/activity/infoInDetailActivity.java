...
public class infoInDetailActivity extends AppCompatActivity {
    ...
    public void pushDataToView (String infoId) {
        ...
        if (list.size() > 0) {
            ...
            textView.setText(((String) textView.getText()).concat("     ").concat((String.valueOf(list.get(0).get("heighth") == null ? "未设置" : list.get(0).get("heighth")))));
            textView = findViewById(R.id.info_one_detail_single);
            textView.setText(((String) textView.getText()).concat("     ").concat((String.valueOf(list.get(0).get("single") == null ? "未设置" : list.get(0).get("single")))));
            textView = findViewById(R.id.info_one_detail_count);
            textView.setText(((String) textView.getText()).concat("     ").concat((String.valueOf(list.get(0).get("count") == null ? "未设置" : list.get(0).get("count")))));
            textView = findViewById(R.id.info_one_detail_total);
            textView.setText(((String) textView.getText()).concat("     ").concat((String.valueOf(list.get(0).get("total") == null ? "未设置" : list.get(0).get("total")))));
